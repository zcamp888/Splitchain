          ...
          {groups.map((g: any) => (
            ...
            >
              <div className="flex items-start justify-between gap-3">
                ...
                <span className="rounded-full border border-border-strong bg-bg-elev/60 px-2 py-0.5 text-xs text-fg-muted">
                  {g.role}
                </span>
              </div>
              <h3 className="mt-3 font-display text-lg font-semibold text-balance line-clamp-1">
                {g.name}
              </h3>
              {g.description && (
                <p className="mt-1 text-sm text-fg-muted line-clamp-2 break-words">
                  {g.description}
                </p>
              )}
