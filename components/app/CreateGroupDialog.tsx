    ...
    >
      <div className="glass-strong w-full max-w-md rounded-3xl p-6 shadow-2xl" onClick={(e) => e.stopPropagation()} style={{ overscrollBehavior: 'contain' }}>
        <div className="flex items-start justify-between">
          <h2 id="create-group-title" className="font-display text-xl font-bold tracking-tight">New group</h2>
        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div>
            <label htmlFor="group-name" className="mb-1.5 block text-xs text-fg-muted">Name</label>
            <input
              id="group-name"
              name="name"
              value={name}
          ...
          <div>
            <label htmlFor="group-desc" className="mb-1.5 block text-xs text-fg-muted">Description (optional)</label>
            <input
              id="group-desc"
              name="description"
              value={description}
          ...
          <div>
            <label htmlFor="group-currency" className="mb-1.5 block text-xs text-fg-muted">Currency</label>
            <select
              id="group-currency"
              name="currency"
              value={currency}
