    ...
    <ToastCtx.Provider value={{ push }}>
      ...
      >
        {toasts.map((t) => (
          ...
          >
            {t.kind === 'success' && <CheckCircle2 className="h-5 w-5 shrink-0 text-success" aria-hidden="true" />}
            {t.kind === 'error' && <AlertCircle className="h-5 w-5 shrink-0 text-danger" aria-hidden="true" />}
            {t.kind === 'info' && <Info className="h-5 w-5 shrink-0 text-neon-cyan" aria-hidden="true" />}
