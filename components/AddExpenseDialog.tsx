        ...
        <form onSubmit={handleSubmit} className="mt-5 space-y-4">
          <div className="grid grid-cols-3 gap-3">
            <div className="col-span-2">
              <label htmlFor="exp-desc" className="mb-1.5 block text-xs text-fg-muted">
                Description
              </label>
              <input
                id="exp-desc"
            ...
            <div>
              <label htmlFor="exp-amount" className="mb-1.5 block text-xs text-fg-muted">
                Amount
              </label>
              <input
                id="exp-amount"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="exp-paidby" className="mb-1.5 block text-xs text-fg-muted">
                Paid by
              </label>
              <select
                id="exp-paidby"
            ...
            <div>
              <label htmlFor="exp-cat" className="mb-1.5 block text-xs text-fg-muted">
                Category
              </label>
              <select
                id="exp-cat"
          ...
          <div>
                  ...
                  >
                    ...
                    {checked && splitMode === 'exact' && (
                      <input
                        ...
                        onChange={(e) =>
                          setExactSplits((prev) => ({ ...prev, [m.user_id]: e.target.value }))
                        }
                        placeholder="0.00"
            ...
            {splitMode === 'exact' && numericAmount > 0 && (
              <div
                className={`mt-2 text-right text-xs tabular font-mono ${Math.abs(exactTotal - numericAmount) < 0.01 ? 'text-success' : 'text-danger'}`}
              >
